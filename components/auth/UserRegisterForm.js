...
function UserRegister() {
  ...
  useEffect(() => {
    ...
    passMatch || passVal.length === 0 ? setPassAlert(false) : setPassAlert(true);
  ...
  return (
    <div className={classes.wrapper}>
      <form className={classes.form} onSubmit={handleSubmit}>
        ...
        <button onClick={handleSubmit} className={classes.submit} disabled={!passMatch}>REGISTER </button>
      </form>
    </div>
  );
}
